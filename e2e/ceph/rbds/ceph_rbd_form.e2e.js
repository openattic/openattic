...
describe('should test the ceph rbd creation form', function(){
  ...
  it('should display the RBD striping preview with ellipsis', function(){
    ...
    expect(stripingPreview.stripes.get(8).getText()).toBe('Stripe 40');
    expect(stripingPreview.stripes.get(9).getText()).toBe('Stripe 41');
    expect(stripingPreview.stripes.get(10).getText()).toBe('Stripe 42');
    ...
    expect(stripingPreview.stripUnits.get(54).getText()).toBe('');
