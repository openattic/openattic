...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Export'
        db.create_table('http_export', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='http_export_set', to=orm['lvm.LogicalVolume'])),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('http', ['Export'])


    def backwards(self, orm):
        # Deleting model 'Export'
        db.delete_table('http_export')
    ...
    models = {
        ...
        'http.export': {
            ...
            'volume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'http_export_set'", 'to': "orm['lvm.LogicalVolume']"})
        },
        'ifconfig.host': {
