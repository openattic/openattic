# -*- coding: utf-8 -*-
#
# openATTIC documentation build configuration file, created by
# sphinx-quickstart on Thu Mar 13 15:42:26 2014.
#
...
project = u'openATTIC'
copyright=u'{year}, SUSE LLC'.format(year=year)
...
.. |reg| unicode:: 0xAE .. registered trademark character
   :ltrim:
.. |release_version| replace:: oa-vm-debian-%s
""" % config_version
...
# of the sidebar.
html_logo = '_static/images/openattic.png'
...
htmlhelp_basename = 'openATTICdoc'
...
# the title page.
latex_logo = '_static/images/openattic.png'
