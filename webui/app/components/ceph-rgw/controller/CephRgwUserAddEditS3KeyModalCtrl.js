...
app.controller("CephRgwUserAddEditS3KeyModalCtrl", function ($scope, $uibModalInstance,
  ...
  if (!angular.isNumber(index)) {
    ...
    $scope.editing = true;
    $scope.key = angular.copy($scope.user.keys[index]);
  }
  ...
  $scope.enumKeySubuserCandidates = function () {
    ...
    if ($scope.editing) {
      ...
      result = cephRgwHelpersService.enumKeyUserCandidates($scope.user, "s3");
    }
    return result;
  };
