...
class CephRgwUserFormS3KeyModal {
  ...
  enumKeySubuserCandidates () {
    ...
    if (this.editing) {
      ...
      result = this.cephRgwHelpersService.enumKeyUserCandidates(this.user, "s3");
    }
    return result;
  }
...
export default {
  template: require("./ceph-rgw-user-form-s3key-modal.component.html"),
  bindings: {
    modalInstance: "<",
    resolve: "<"
  },
  controller: CephRgwUserFormS3KeyModal
};
