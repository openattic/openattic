...
class CephRgwUserFormSwiftKeyModal {
   ...
   */
  enumKeySubuserCandidates () {
    let result = [];
    if (this.editing) {
      result.push(this.key.user);
    } else {
      result = this.cephRgwHelpersService.enumKeyUserCandidates(this.user, "swift");
    }
    return result;
  }
...
export default {
  template: require("./ceph-rgw-user-form-swiftkey-modal.component.html"),
  bindings: {
    modalInstance: "<",
    resolve: "<"
  },
  controller: CephRgwUserFormSwiftKeyModal
};
