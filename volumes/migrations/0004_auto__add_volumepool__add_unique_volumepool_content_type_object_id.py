...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'VolumePool', fields ['content_type', 'object_id']
        db.create_unique('volumes_volumepool', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VolumePool', fields ['content_type', 'object_id']
        db.delete_unique('volumes_volumepool', ['content_type_id', 'object_id'])
