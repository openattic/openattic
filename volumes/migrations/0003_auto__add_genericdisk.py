...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericDisk'
        db.create_table('volumes_genericdisk', (
        ...
        db.send_create_signal('volumes', ['GenericDisk'])


    def backwards(self, orm):
        # Deleting model 'GenericDisk'
        db.delete_table('volumes_genericdisk')
